...
let website = "/RouteProvider"

let githubLink = "http://github.com/isaksky/RouteProvider"

// Specify more information about your project
let info =
  [ "project-name", "RouteProvider"
    "project-author", "Isak Sky"
    "project-summary", "A type provider for normal RESTy routes"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/RouteProvider" ]
